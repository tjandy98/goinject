...
func WriteProcessMemory(hProcess HANDLE, lpBaseAddress uintptr, data []byte, size uint) (err error) {
...
func ReadProcessMemory(hProcess HANDLE, lpBaseAddress uintptr, size uint) (data []byte, err error) {
	var numBytesRead uintptr
	data = make([]byte, size)
